...
- [Figma construction standard](figma-construction-standard.md)
- [Executable component specification format](component-specification-format.md)
- [Mandatory foundation documentation](foundation-documentation.md)
